		...
		<div class="col-md-12">
			<div class="card card-primary">
			  <div class="card-header"><h3>Data Kategori</h3>
			  	<div class="card-title pull-right"><a href="{{ route('admin.kategori.create') }}">Tambah</a>
			  	</div>
			  </div>
			  			  <script>
function myFunction() {
			  ...
			  <div class="card-body">
				  ...
				  <table class="table table-borederless table-striped table-earning" id="myTable">
				  	...
				  	<tbody>
				    	...
				    	<td>{{ $data->slug }}</td>
						<td>
							<a class="btn btn-warning" href="{{ route('admin.kategori.edit',$data->id) }}">Edit</a>
						</td>
						<td>
							<form method="post" action="{{ route('admin.kategori.destroy',$data->id) }}">

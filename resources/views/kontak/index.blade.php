...
<div class="limiter">
	<div class="container-login100">
		...
		@include('sweet::alert')
			...
			<h1><center><div class="panel-heading">Data Kontak</center></h1> 
			 <div class="panel-title pull-right"><a href="{{ route('kontak.create') }}"><i class="fa fa-plus"></i>Tambah</a>
                  </div>
